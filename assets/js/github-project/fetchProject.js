...
const projects = [
  {
    name: "The anonymous feedback platform",
    image: `<img loading="eager" src= './../../assets/img/project/advice-hub.png' alt="the developer advice hub designed project by unclebay" />`,
    description:
      "An advice center for developers from developers in a single place. This project is a submission for auth0 x hashnode hackathon, this project did not made it to the runner up.",
    created_at: "08/21/2021",
    homepage: "https://advicehub.netlify.app/",
    html_url: "https://unclebigbay.com/introducing-the-advice-hub",
  },
  {
    name: "The anonymous feedback platform",
    image: `<img loading="eager" src= './../../assets/img/project/anonymous-feedback.png' alt="anonymous feedback designed project by unclebay" />`,
    description:
      "This project allows you to receive anonymous feedback from people without knowing the sender. This project is a submission for clerk x hashnode hackathon, this project made it to the runner up.",
    created_at: "07/28/2021",
    homepage: "https://anonymousfeedback.netlify.app/",
    html_url:
      "https://unclebigbay.com/introducing-the-anonymous-feedback-platform-powered-by-the-chern-stack",
  },
  {
    name: "Developer Typing Game",
    image: `<img loading="eager" src= './../../assets/img/project/developer-typing-game.png' alt="developer typing game project developed by unclebay" />`,
    description:
      "A game that helps developers get familiarized with their programming language and also enjoy lofi music, This project is a submission for harperdb x hashnode hackathon, this project made it to the runner up.",
    created_at: "06/29/2021",
    homepage: "https://developer-typing-game.netlify.app/",
    html_url:
      "https://unclebigbay.com/introducing-developer-typing-game-platform-powered-by-the-hern-stack",
  },
  {
    ...
    description:
      "A network provider service, where users can purchase data and airtime and pay with flutterwave",
    created_at: "04/23/2020",
    homepage: "https://customer-self-service.netlify.app/",
    html_url:
      "https://github.com/unclebay143/customer-self-service-with-flutterwave-payment-gateway#readme",
  },
  {
    name: "Forbes Website",
    image: `<img loading="eager" src= './../../assets/img/project/forbes.png' alt="forbes website built by unclebay" />`,
    description:
      "A real-time website showing the list of the world billionaire",
    created_at: "04/23/2020",
  ...
  },
  {
    ...
    description:
      "An online based employee time-sheet built with React, Redux and Node JS",
  ...
  },
  {
    ...
    description:
      "Online platform for jambites to study novel question for 2021 JAMB exams in Nigeria",
...
const projectCard = (repos) => {
  ...
  for (let i = 0; i < totalProjects.length; i++) {
    const { name, created_at, description, html_url, homepage, image } =
      totalProjects[i];
    tempHolder += `
        <div class="project-card reveal ${i === 0 && "active"} ${
      i === 1 && "active"
    }">
                   ${image ? image : images[i] ? images[i] : images[0]}
                    <div class="project__description">
                        <p class="project__title">${name}</p>
                        <em class="project__creation__date">Created ${formatDate(
                          created_at
                        )}</em> <br />
                        <span class="project__about">${
